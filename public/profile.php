...
$user = new User();
$theUser = $user->getAllWhere("users", "id = {$id}")[0];
...
<body>
  ...
  <div id="app">
    ...
    include_once ROOT . 'partials/_navigation-bar.php';

    // import side menu bar
    include_once ROOT . 'partials/_side-menu.php';

    // import breadcrumbs
    include_once ROOT . 'partials/_navigation-breadcrumbs.php';

    // import session messages
    include_once ROOT . 'partials/_session-messages.php';
    ?>
    ...
    <?php
    // import footer
    include_once ROOT . 'partials/_footer.php';
    ?>
