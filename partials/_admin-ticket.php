...
<section class="section main-section">
    <?php if ($theTicket['id']) : ?>
        <div class="card has-table">
            ...
            ?>
                <div class="p-8 pb-0">
                    <a href="../admin/split-ticket.php?ticket=<?= $theTicket['id'] ?>" class="button blue w-full text-white font-bold">
                        Split Ticket
                    </a>
                </div>
            <?php
            ...
            <div class="border-2 border-gray-200 p-3 text-lg italic mb-4 bg-yellow-50">
                ...
                <?php
                // Generates notification for split a ticket.
                if ($theTicket["closed_date"] !== NULL && $theTicket["closing_type"] === "split") {
                    require_once '../../classes/services/SplitTicketNotification.php';
