<aside class="aside is-placed-left is-expanded">
  ...
  <div class="menu is-menu-main">
    ...
    <ul class="menu-list">
      ...
      <?php endif; ?>
      <li class="--set-active-tables-html">
        <a href="<?= BASE_URL ?>my-dashboard.php">
    ...
    <ul class="menu-list">
      <?php if ($_SESSION['user_role'] === "admin") : ?>
        <li class="--set-active-tables-html">
          <a href="<?= BASE_URL ?>admin/admin-ticket-listing.php">
      ...
      <li class="--set-active-tables-html">
        <a href="<?= BASE_URL ?>user/user-ticket-listing.php">
      ...
      <li class="--set-active-profile-html">
        <a href="<?= BASE_URL ?>profile.php?user=<?= cleanString($_SESSION["user_id"]) ?>">
